...
La salida de la etiqueta es solo un entero como en este ejemplo: 'entero'.
Recuerde que una noticia falsa es un contenido engañoso estrechamente relacionado con la propaganda y la manipulación de hechos que buscan principalmente engañar. Su definición incluye el engaño intencional de una audiencia masiva por parte de actores no mediáticos a través de una comunicación sensacionalista que parece creíble pero está diseñada para manipular y no se revela como falsa.
