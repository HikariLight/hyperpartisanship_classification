...
with open("./data/Vista_5_runs.json") as json_file:
...
Determine if the headline is hyperpartisan or not. The possible choices are: ’0’ if the article is neutral, ’1’ if the article is hyperpartisan.
### Examples: 
{} 
